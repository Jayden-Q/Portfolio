...
const styles = {
  ...
  navbarContainerStyle: `fixed top-4 sm:top-5 left-0 w-full flex justify-center z-[10] px-3 sm:px-4`,

  navbarStyle: `flex items-center justify-center
      ...
      <ul className={styles.navbarStyle}>
        <li>
          <Link href="/">
            ...
            <HoverFlipText as="span" text="Home" className={styles.textStyle} />
          </Link>
        </li>
        <li>
          <Link href="#portfolio">
