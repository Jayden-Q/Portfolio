...
const Portfolio = () => {
  ...
  return (
  <section
    className="relative min-h-screen overflow-hidden px-4 py-10 sm:px-6 xl:px-10 xl:py-40"
    id="portfolio"
  >
    <div className="relative z-1 mx-auto max-w-350">
    ...
    <div className="relative z-1 mb-[100px] -mx-4 overflow-visible sm:-mx-6 xl:-mx-10">
      <div
        ref={trackRef}
